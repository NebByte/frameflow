...
def test_the_ledger_answers_questions_and_takes_no_orders():
    ...
    for bad in ("DROP TABLE screenx_shots",
                "INSERT INTO screenx_shots VALUES (1)",
                "TRUNCATE TABLE screenx_shots",
                "ALTER TABLE screenx_shots DELETE WHERE 1=1",
                "select 1; drop table screenx_shots"):
        try:
...
def test_the_agent_builds_without_a_database():
    ...
    a = build_agent()
    check("it builds", a is not None and a.name == "screenx_supervisor")
