...
every frame through its own hole -- the fence does not move. `render`
...
class WaveSpeedOutpainter:
    ...
    def __init__(self, token=None, base=DEFAULT_BASE, model=DEFAULT_MODEL,
        ...
        # SCREENX_TOKEN is still read: a shell profile written before
        # the rename should not silently stop supplying a key.
        self.token = (token
