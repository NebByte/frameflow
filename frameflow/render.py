"""
render — the full pipeline to a watchable three-panel video.
...
from . import offscreen as ofs
from . import reasoning as rz
from . import filmindex as fx
...
def run(path, outdir="jobs/cli", maxw=480, max_shots=None,
    ...
    if sfm_dir and index is not None:
        from . import sfm  # min_setups=1 under --prefer-3d. The default of 2 skips a lone shot on
